import { An as Fragment$1, Cn as Selection$2, Ct as isAtEndOfNode, En as Mapping, Mt as isNodeActive, Nn as Slice$1, Nt as isNodeEmpty, On as dropPoint, Pt as isNodeSelection, R as findChildrenInRange, Sn as PluginKey, Tn as TextSelection$1, Ut as markInputRule, Wt as markPasteRule, Xt as nodeInputRule, Y as getChangedRanges, Z as getExtensionField, _n as keydownHandler, at as getNodeType, b as combineTransactionSteps, bn as NodeSelection$1, c as Mark$1, en as parseIndentedBlocks, gn as wrappingInputRule, i as Extension, in as renderNestedMarkdownContent, k as createStyleTag, mn as textblockTypeInputRule, nt as getMarksBetween, ot as getRenderedAttributes, q as getAttributes, qt as mergeAttributes, rt as getNodeAtPosition, u as Node3, v as callOrReturn, vn as Decoration, wt as isAtStartOfNode, xn as Plugin, y as canInsertNode, yn as DecorationSet } from "./dist-Et-y4UHu.js";
...
var TextSelection = class _TextSelection extends Selection$1 {
	/**
...
var NodeSelection = class _NodeSelection extends Selection$1 {
	/**
...
var AllSelection = class _AllSelection extends Selection$1 {
	/**
		...
		return {
			...
			ArrowDown: ({ editor }) => {
				...
				if (doc.nodeAt(after)) return editor.commands.command(({ tr }) => {
					tr.setSelection(Selection$2.near(doc.resolve(after)));
					return true;
				});
...
*/
var GapCursor = class GapCursor extends Selection$2 {
	/**
	Create a gap cursor.
	*/
	constructor($pos) {
	...
	map(doc, mapping) {
		...
		return GapCursor.valid($pos) ? new GapCursor($pos) : Selection$2.near($pos);
	}
	content() {
...
Selection$2.jsonID("gapcursor", GapCursor);
...
function handleClick(view, pos, event) {
	...
	if (clickPos && clickPos.inside > -1 && NodeSelection$1.isSelectable(view.state.doc.nodeAt(clickPos.inside))) return false;
