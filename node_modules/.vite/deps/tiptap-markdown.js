...
import { An as Fragment, I as extensions_exports, Mn as Schema, Q as getHTMLFromFragment, Sn as PluginKey, c as Mark$1, i as Extension, jn as Mark, kn as DOMParser, u as Node3, xn as Plugin } from "./dist-Et-y4UHu.js";
...
var Blockquote$1 = Node3.create({ name: "blockquote" }).extend({ 
/**
...
var BulletList$1 = Node3.create({ name: "bulletList" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var CodeBlock$1 = Node3.create({ name: "codeBlock" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var HardBreak$1 = Node3.create({ name: "hardBreak" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Heading$1 = Node3.create({ name: "heading" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var HorizontalRule$1 = Node3.create({ name: "horizontalRule" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Image$1 = Node3.create({ name: "image" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var ListItem$1 = Node3.create({ name: "listItem" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Paragraph$1 = Node3.create({ name: "paragraph" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Table$1 = Node3.create({ name: "table" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var markdownExtensions = [
	...
	Paragraph$1,
	Table$1,
	Node3.create({ name: "taskItem" }).extend({ 
	/**
	* @return {{markdown: MarkdownNodeSpec}}
	*/
addStorage() {
	...
	Node3.create({ name: "taskList" }).extend({ 
	/**
	* @return {{markdown: MarkdownNodeSpec}}
	*/
addStorage() {
...
addStorage() {
	...
	Mark$1.create({ name: "bold" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
	...
	Mark$1.create({ name: "code" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
	...
	HTMLMark,
	Mark$1.create({ name: "italic" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
	...
	Mark$1.create({ name: "link" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
	...
	Mark$1.create({ name: "strike" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
