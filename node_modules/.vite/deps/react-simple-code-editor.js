...
//#region node_modules/react-simple-code-editor/lib/index.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Editor = React.forwardRef(function Editor(props, ref) {
			...
			if (e.key === "Tab" && !ignoreTabKey && capture) {
				...
				if (e.shiftKey) {
					...
					var nextValue = value.split("\n").map(function(line, i) {
						if (i >= startLine_1 && i <= endLine_1 && line.startsWith(tabCharacter)) return line.substring(tabCharacter.length);
						return line;
					}).join("\n");
					if (value !== nextValue) {
					...
					applyEdits({
						value: value.split("\n").map(function(line, i) {
							if (i >= startLine_2 && i <= endLine_2) return tabCharacter + line;
							return line;
						}).join("\n"),
				...
				if (value.substring(0, selectionStart).endsWith(tabCharacter) && !hasSelection) {
					e.preventDefault();
					var updatedSelection = selectionStart - tabCharacter.length;
					applyEdits({
		...
		return React.createElement("div", __assign({}, rest, { style: __assign(__assign({}, styles.container), style) }), React.createElement("pre", __assign({
